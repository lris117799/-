...
class MapFloatingWindow(QWidget):
    ...
    def __init__(self, parent=None, game_capture=None):
        ...
        sc_dir = os.path.join(image_dir, 'sc')
    ...
    def _init_ui(self):
        ...
        self.owl_stars_btn.setFixedWidth(120)
    ...
    def _start_navigation(self):
        ...
        full_map_path = os.path.join(base_dir, 'map_full_hq_resized.png')
    ...
    def update_map_display(self, map_image_path=None, collect_data=None):
        """更新地图显示"""
        # 加载资源数据
        if collect_data:
    ...
    def _game_to_map_coords(self, lat, lng):
        """将游戏坐标转换为地图像素坐标（针对 4096x3072 高清地图）"""
        # 根据实际测试数据计算的参数
        scale_x = 0.669147
    ...
    def wheelEvent(self, event):
        ...
        if hasattr(self, 'map_label') and self.map_label.underMouse():
            ...
            if event.modifiers() & Qt.ControlModifier:
                ...
                # 限制缩放范围
                self.map_scale = max(0.5, min(self.map_scale, 10.0))
